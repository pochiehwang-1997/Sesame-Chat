"""
Django settings for sesame_chat project.
...
SECRET_KEY = 'django-insecure-g6ba5p)gmxs2i-u)wmav^@x1cg4_5*jb)-w7c&_1qk8*%*bk$*'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "sesame_chat/static")
]
